...
if(FLANN_USE_STATIC)
  set(FLANN_RELEASE_NAME flann.lib)
  set(FLANN_DEBUG_NAME flann.lib)
...
#message(STATUS "${FLANN_RELEASE_NAME}  ${FLANN_DEBUG_NAME}")
find_path(FLANN_INCLUDE_DIR flann/flann.hpp
          #HINTS ${PC_FLANN_INCLUDEDIR} ${PC_FLANN_INCLUDE_DIRS}
				#ENV FLANN_ROOT
          PATHS $ENV{FLANN_ROOT}/src/cpp
...
find_library(FLANN_LIBRARY
             ...
             HINTS ${PC_FLANN_LIBDIR} ${PC_FLANN_LIBRARY_DIRS}
					ENV FLANN_ROOT
             PATHS "$ENV{PROGRAMFILES}/Flann" "$ENV{PROGRAMW6432}/Flann" $ENV{FLANN_ROOT}/build/lib/Release
	     PATH_SUFFIXES lib)

find_library(FLANN_LIBRARY_DEBUG 
             NAMES ${FLANN_DEBUG_NAME}
	     HINTS ENV FLANN_ROOT
	     PATHS $ENV{FLANN_ROOT}/build/lib/Debug
	     PATH_SUFFIXES lib)
		 
#message(STATUS "${FLANN_LIBRARY_DEBUG}")
