...
if(NOT DEFINED LIBDIR)
  ...
  if(MSVC_VERSION GREATER 1919)
    ...
    set(LIBDIR ${CMAKE_BINARY_DIR}/../../../lib/${LIBDIR_BASE}_vc14)
  ...
  elseif(MSVC_VERSION EQUAL 1900)
    ...
    set(LIBDIR ${CMAKE_BINARY_DIR}/../../../lib/${LIBDIR_BASE}_vc12)
  endif()
else()
...
set(ZLIB_OUT ${CMAKE_BINARY_DIR}/../../zlib/build/)
set(ZLIB_INCLUDE_DIRS ${ZLIB_ROOT}/src/ ${ZLIB_OUT})
set(ZLIB_LIBRARIES ${LIBDIR}/zlib/lib/libz_st.lib)
set(ZLIB_INCLUDE_DIR ${ZLIB_ROOT}/src/ ${ZLIB_OUT})
...
if(NOT PNG_FOUND)
  ...
  set(PNG_BUILD_OUT ${CMAKE_BINARY_DIR}/../../libpng/build/)
  set(PNG_PNG_INCLUDE_DIR ${PNG_ROOT}/src/ ${PNG_BUILD_OUT})
  set(PNG_LIBRARIES ${LIBDIR}/png/lib/libpng.lib)
  set(PNG "${LIBDIR}/png")
  set(PNG_INCLUDE_DIRS "${PNG_ROOT}/src/" ${PNG_BUILD_OUT})
...
if(NOT JPEG_FOUND)
  ...
  set(JPEG_ROOT ${CMAKE_SOURCE_DIR}/../../jpeg/)
  set(JPEG_INCLUDE_DIR ${JPEG_ROOT}/src/)
  set(JPEG_LIBRARIES ${LIBDIR}/jpeg/lib/libjpeg.lib)
endif()

set(PTHREADS_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/../../pthreads/src/)
set(PTHREADS_LIBRARIES ${LIBDIR}/pthreads/lib/pthreadVC3.lib)

set(FREETYPE ${CMAKE_SOURCE_DIR}/../../freetype/src/)
set(FREETYPE_INCLUDE_DIRS
  ${CMAKE_SOURCE_DIR}/../../freetype/src/include/
  #${LIBDIR}/freetype/include/freetype2
  ${CMAKE_BINARY_DIR}/../../freetype/build/include/
)
set(FREETYPE_LIBRARY ${LIBDIR}/freetype/lib/freetype2ST.lib)
windows_find_package(freetype REQUIRED)

if(WITH_FFTW3)
  set(FFTW3 ${CMAKE_SOURCE_DIR}/../../fftw3/src/)
  set(FFTW3_LIBRARIES ${FFTW3}/lib/libfftw.lib)
  set(FFTW3_INCLUDE_DIRS ${FFTW3}/api/)
  set(FFTW3_LIBPATH ${FFTW3}/lib)
endif()

if(WITH_OPENCOLLADA)
  set(OPENCOLLADA ${CMAKE_SOURCE_DIR}/../../OpenCOLLADA/src/)
...
if(WITH_CODEC_FFMPEG)
  set(FFMPEG_ROOT ${CMAKE_SOURCE_DIR}/../../ffmpeg/src/)
...
if(WITH_IMAGE_OPENEXR)
  ...
  if(NOT OPENEXR_FOUND)
    ...
    set(OPENEXR ${CMAKE_SOURCE_DIR}/../../openexr/src/)
	set(OPENEXR_BASE ${CMAKE_SOURCE_DIR}/../../ilmbase/src/)
    set(OPENEXR_INCLUDE_DIR ${OPENEXR}/include)
    set(OPENEXR_INCLUDE_DIRS ${OPENEXR_INCLUDE_DIR} ${OPENEXR}/IlmImf/ ${OPENEXR_BASE}/Half/ ${OPENEXR_BASE}/Imath/ ${OPENEXR_BASE}/Iex/
		${OPENEXR_BASE}/config.windows/ ${OPENEXR}/config.windows/ )
...
if(WITH_IMAGE_TIFF)
  ...
  if(NOT TIFF_FOUND)
	...
	set(TIFF_ROOT ${CMAKE_SOURCE_DIR}/../../tiff/src/)
    set(TIFF_LIBRARY ${LIBDIR}/tiff/lib/libtiff.lib)
    set(TIFF_INCLUDE_DIR ${TIFF_ROOT}/libtiff/)
  endif()
endif()
...
if(WITH_PYTHON)
  ...
  set(PYTHON_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/../../Python/src/include/)
  set(PYTHON_PC_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/../../Python/src/PC/)
  set(PYTHON_NUMPY_INCLUDE_DIRS ${LIBDIR}/python/${_PYTHON_VERSION_NO_DOTS}/lib/site-packages/numpy/core/include)
  set(NUMPY_FOUND On)
  unset(_PYTHON_VERSION_NO_DOTS)
  # uncached vars
  set(PYTHON_INCLUDE_DIRS "${PYTHON_INCLUDE_DIR}" "${PYTHON_PC_INCLUDE_DIR}")
...
if(WITH_BOOST)
  ...
  if(NOT Boost_FOUND)
    ...
    set(BOOST ${CMAKE_SOURCE_DIR}/../../BOOST/src)
...
if(WITH_OPENIMAGEIO)
  ...
  set(OPENIMAGEIO ${CMAKE_SOURCE_DIR}/../../oiio/src/)
  set(OPENIMAGEIO_LIBPATH ${OPENIMAGEIO}/lib)
  set(OPENIMAGEIO_INCLUDE_DIRS ${OPENIMAGEIO}/src/include)
...
if(WITH_OPENCOLORIO)
  set(OPENCOLORIO ${CMAKE_SOURCE_DIR}/../../OpenColorIO/src/)
  set(OPENCOLORIO_INCLUDE_DIRS ${OPENCOLORIO}/export/)
...
if(WITH_OPENVDB)
  set(OPENVDB ${CMAKE_SOURCE_DIR}/../../openvdb/src/)
  set(BLOSC_LIBRARIES optimized ${LIBDIR}/blosc/lib/libblosc.lib debug ${LIBDIR}/blosc/lib/libblosc_d.lib)
  set(OPENVDB_LIBPATH ${OPENVDB}/lib)
  set(OPENVDB_INCLUDE_DIRS ${OPENVDB}/openvdb/)
...
if(WITH_ALEMBIC)
  set(ALEMBIC ${CMAKE_SOURCE_DIR}/../../alembic/src/)
  set(ALEMBIC_INCLUDE_DIR ${ALEMBIC}/lib/)
...
if(WITH_IMAGE_OPENJPEG)
  set(OPENJPEG ${CMAKE_SOURCE_DIR}/../../OpenColorIO/src/src/lib/openjp2/)
  set(OPENJPEG_INCLUDE_DIRS ${OPENJPEG})
...
if(WITH_SYSTEM_AUDASPACE)
  set(AUDASPACE_ROOT ${CMAKE_SOURCE_DIR}/../../audaspace/src/include/)
  set(AUDASPACE_INCLUDE_DIRS ${AUDASPACE_ROOT})
  set(AUDASPACE_LIBRARIES ${LIBDIR}/audaspace/lib/audaspace.lib)
  set(AUDASPACE_C_INCLUDE_DIRS ${AUDASPACE_ROOT})
  set(AUDASPACE_C_LIBRARIES ${LIBDIR}/audaspace/lib/audaspace-c.lib)
  set(AUDASPACE_PY_INCLUDE_DIRS ${AUDASPACE_ROOT})
  set(AUDASPACE_PY_LIBRARIES ${LIBDIR}/audaspace/lib/audaspace-py.lib)
endif()

if(WITH_TBB)
  set(TBB_LIBRARIES optimized ${LIBDIR}/tbb/lib/tbb.lib debug ${LIBDIR}/tbb/lib/tbb_debug.lib)
  set(TBB_INCLUDE_DIR ${CMAKE_SOURCE_DIR}/../../tbb/src/include)
...
set(WINTAB_INC ${CMAKE_SOURCE_DIR}/../../wintab/src/include)
...
if(WITH_CYCLES_EMBREE)
  ...
  if(NOT EMBREE_FOUND)
    set(EMBREE_INCLUDE_DIRS ${CMAKE_SOURCE_DIR}/../../embree/src/)
